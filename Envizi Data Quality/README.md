...
- **`Claude_dispatch_prompts_-_NZ_certificates.md`** — the browser-dispatch prompts that fix findings §2 and §7: survey,
  FY27 grid and REC factors, close the Hastings duplicate, read-only check. The 21 genuine relationships
  are left as they are (names and blank dates) - the reasoning is at the top of the file.
